...
def clean_headers(df):
    ...
    df = df.rename(columns = {"Department":"department","Name":"product_name","Fee Multiplier": "crv_by_05_cents"})
    df = df[["upc","department","product_name","crv_by_05_cents","Price","size"]]
    return df
