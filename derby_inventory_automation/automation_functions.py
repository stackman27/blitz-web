...
def crv_column(df):
    has_crv = []
    departments = ["Soda", "Water/Juices", "Energy",
                   "Sports Drinks", "Drinks", "Teas/coffees"]
...
def find_sugar(df):
    ...
    table4 = df[(df["department"] == "Soda") | (df["department"] == "Water/Juices") | (df["department"] == "Sports Drinks")
                | (df["department"] == "Energy") | (df["department"] == "Drinks") | (df["department"] == "Kombucha")].reset_index()
    sugar_column = []
